(custom-set-variables
 ...
 '(elfeed-feeds
   '("https://canvas.umw.edu/feeds/announcements/enrollment_PG6SUNeI0kQ9WJbzDyQtBfI7bNmH3b3IxQ8YowkQ.atom"
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((((class color) (min-colors 16777215)) (:background "#282828" :foreground "#fdf4c1" :family "Iosevka" :foundry "CYEL" :slant normal :weight normal :height 120 :width normal)) (((class color) (min-colors 255)) (:background "#262626" :foreground "#ffffaf" :family "Iosevka" :foundry "CYEL" :slant normal :weight normal :height 120 :width normal))))
