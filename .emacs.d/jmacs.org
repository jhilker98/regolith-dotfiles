...
(use-package general)
    #+end_src
*** Org Plus Contrib
    The updated version of org-mode. However, whenever I load this, it gives
    me an error. I need to fix that - specifically the error of
    org-priority-highest being void.
    #+begin_src emacs-lisp
;(use-package org
...
(use-package all-the-icons)
    #+end_src
*** Dashboard
    Dashboard allows me to have a simple dashboard as a startup buffer. This also contains my UI tweaks for it, and what I want to show - namely my 5 last files and my projects.
    #+begin_src emacs-lisp
...
(make-mu4e-context
	  ...
	  :vars '((user-mail-address . "camohilk@gmail.com")
		  ...
		  (smtpmail-smtp-service . 465)
		  (smtpmail-stream-type  . ssl)
			(mu4e-update-func "mbsync jacob.hilker2@gmail.com")
...
*** UI Tweaks 
**** Headers
		 I want to have a different view of each date.
		 #+begin_src emacs-lisp
...
*** Email Workflow
**** Follow Up
		 This is what I want to use when I want to find an email to follow-up.
		 #+begin_src emacs-lisp
