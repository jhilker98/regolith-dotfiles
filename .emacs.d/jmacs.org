...
- [[#introduction-to-jmacs][*Introduction to JMACS*]]
      ...
      - [[#enabling-babel-indentation-support][Enabling Babel Indentation Support]]
...
- [[#specific-functions][Specific Functions]]
      ...
      - [[#agenda-functions][Agenda Functions]]
...
#+END_SRC
** Enabling Babel Indentation Support
   #+begin_src emacs-lisp
...
;   (set-frame-font "InconsolataLGC Nerd Font-12" nil t)
