...
** Fonts
I love Iosevka as a monospace font. All the different variants help as well. I'm still looking around for a good font for variable width.
#+begin_src emacs-lisp
(set-face-attribute 'default nil :font (font-spec :family "Iosevka Nerd Font" :height 20 :size 16)) 
(set-face-attribute 'org-meta-line nil :inherit 'default)

;  (set-face-attribute 'variable-pitch nil :font (font-spec :family "Alegreya" :size 14))
#+end_src
