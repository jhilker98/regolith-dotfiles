...
I keep my agenda files in Dropbox so that I can access them on any computer. In addition, I want a different ellipsis instead of the three periods. Most of my todo keywords are fairly straightforward. The PROJECT todo keyword is for me to mark something as a project.
#+begin_src emacs-lisp
(setq org-agenda-files '("~/Dropbox/org/agenda.org" "~/Dropbox/org/inbox.org") 
      org-ellipsis " ▼ "

      org-todo-keywords '(
                            (sequence "TODO(t)" "NEXT(n)" "HOLD(h)" "REVIEW(r)" "|" "DONE(d!)" "CANCELLED(c!)")
...
*** Task
This adds an item to the inbox file to be refiled later.
#+begin_src emacs-lisp
(setq org-capture-templates
			     ...
			     '(
                   ...
                   (org-super-agenda-groups
                    '(
                         ...
                         (:name "Personal"
                          :category ("WRITING" "CAMPAIGN" "PERSONAL")
                          :order 4)
