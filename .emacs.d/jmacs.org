...
#+begin_src emacs-lisp
(setq org-agenda-files '("~/Dropbox/org/agenda.org" "~/Dropbox/org/projects.org" "~/Dropbox/org/contacts.org")
      org-ellipsis " ▼ "
      org-todo-keywords '((sequence "TODO(t)"  "NEXT(n)" "WAIT(w@/!)" "HOLD(h)" "BLOCK(b@!)" "|" "DONE(d!)" "CANC(c!)"))
      org-todo-keyword-faces '(
                               ("TODO" . (:foreground "#cc241d" :weight bold )) ;; red, bold, underlined
                               ("BLOCK" . (:foreground "#cc241d" :weight bold )) ;; red, bold
                               ("NEXT" . (:foreground "#fe8019" :weight bold)) ;; orange, bold
                               ("WAIT" . (:foreground "#b16286" :weight bold :slant italic)) ;; purple, bold, italic
                               ("HOLD" . (:foreground "#b16286" :weight bold :underline t)) ;; purple, bold, underline
                               ("DONE" . (:foreground "#83a598" :weight bold :strike-through t)) ;; blue, strikethrough
                               ("CANC" . (:foreground "#83a598" :weight bold :strike-through t)))) ;; blue - strikethrough
      #+end_src
