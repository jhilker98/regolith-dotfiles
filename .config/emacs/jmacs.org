...
- [[#introduction-to-jmacs][*Introduction to JMACS*]]
      ...
      - [[#agenda-file-setup][Agenda File Setup]]
...
- [[#specific-functions][Specific Functions]]
      ...
      - [[#one-group-for-centaur-tabs-1][One Group for Centaur Tabs]]
...
- [[#hooks-and-general-non-ui-config][Hooks and General (Non-UI) Config]]
      ...
      - [[#use-latex-snippets-in-org-mode][Use \LaTeX Snippets in Org Mode]]
