...
*** Dashboard
This dashboard view allows me to get a view of my day, along with my todo items. First is a daily schedule, and then any upcoming deadlines, and finally the inbox and then a general todo list. In addition, I don’t want to see any done tasks - this mostly looks forward. I don't include any projects on it simply because I have a project kanban board.
#+begin_src emacs-lisp
